...
# Inside the constructor, ingrement the class variable No of Books by 1 whenever a new object is created.
...
class BookStore:
    ...
    def Display(self):
        print(f"Book Name : {self.Name} || Author : {self.Author} || No of Books : {BookStore.NoOfBooks}")
